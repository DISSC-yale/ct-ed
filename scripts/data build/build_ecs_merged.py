...
OUT  = os.path.join(HERE, "ecs_shells_merged.csv")

OLDER = os.path.join(HERE, "ecs shells")  # folder with older shells

# ── Shell file registry ───────────────────────────────────────────────────────
SHELLS = {
    2018: (os.path.join(OLDER, "ECS Shell 2017-18 Final Version.xls"),               "Simulation1",  "xls"),
    2019: (os.path.join(OLDER, "ecs shell 2018-19-only.xlsx"),                        "FY 2018-19",   "xlsx"),
    2020: (os.path.join(OLDER, "ecs shell 2019-2020.xlsx"),                           "FY 2019-20",   "xlsx"),
    2021: (os.path.join(OLDER, "ecs shell 2020-21.xlsx"),                             "FY 2020-21",   "xlsx"),
    2022: (os.path.join(OLDER, "ecs shell 2021-22.xlsx"),                             "Current Law",  "xlsx"),
    2023: (os.path.join(OLDER, "ecs shell 2022-23.xlsx"),                             "Current Law",  "xlsx"),
    2024: (os.path.join(HERE,  "FY_2023-2024_ECS_shell.xlsx"),                        "FY 24",        "xlsx"),
    2025: (os.path.join(HERE,  "FY_2024-2025_ECS_shell.xlsx"),                        "FY 25",        "xlsx"),
    2026: (os.path.join(HERE,  "FY_2025-2026_ECS_shell.xlsx"),                        "FY 26",        "xlsx"),
    2027: (os.path.join(HERE,  "FY_2026-2027_ECS_shell_and_out_years.xlsx"),          "FY 27",        "xlsx"),
}
...
COL_MAP_FY2019 = [
    ...
    (40, "computed__ecs_entitlement_with_alliance_hh", "computed"),  # col 40 = final entitlement FY2019
]
...
COL_MAP_FY2020 = [
    ...
    (41, "computed__ecs_entitlement_with_alliance_hh", "computed"),  # col 41 = final entitlement FY2020
]
...
COL_MAP_FY2021 = [
    ...
    (40, "computed__fully_funded_grant_with_alliance_hh", "computed"),
...
COL_MAP_FY2023 = [
    ...
    (40, "input__ecs_actual_fy2017",                   "input"),
...
def extract_data_xls(ws, col_map, data_start_row, fiscal_year, params):
    ...
    for r in range(data_start_row - 1, ws.nrows):
        ...
        if not isinstance(town, str) or not town.strip() or town.strip() in ('Totals', 'Total'):
            continue
...
for fy, (path, sheet, fmt) in SHELLS.items():
    ...
    flag_cols = [
        "input__psd_flag", "input__alliance_district_flag",
        "input__alliance_non_reform_flag", "input__reform_district_flag",
    ]
    for rec in rows:
        for fc in flag_cols:
